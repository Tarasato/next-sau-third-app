        ...
        <div className="bg-white p-8 rounded-3xl shadow-2xl w-full mb-8">
            ...
            <div className="space-y-6">
                <div>
                    ...
                    <input type="string" id="carOwner" placeholder="ชื่อ-นามสกุล" className="w-full px-4 py-3 rounded-xl bg-slate-100 text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200"/>
                </div>

                <div>
                    <label className="block text-slate-700 font-semibold mb-2">ราคารถยนต์ (บาท)</label>
                    <input type="number" id="carPrice" placeholder="0.00" className="w-full px-4 py-3 rounded-xl bg-slate-100 text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200"/>
                </div>
                
                <div>
                    <label className="block text-slate-700 font-semibold mb-2">อัตราดอกเบี้ยต่อปี (%)</label>
                    <input type="number" id="interestRate" placeholder="0.00" className="w-full px-4 py-3 rounded-xl bg-slate-100 text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200"/>
                </div>
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                        <label className="inline-flex items-center">
                            <input type="radio" name="downPayment" value="5" className="form-radio text-indigo-600 focus:ring-indigo-500"/>
                            <span className="ml-2 text-slate-700">15%</span>
                        </label>
                        <label className="inline-flex items-center">
                            <input type="radio" name="downPayment" value="10" className="form-radio text-indigo-600 focus:ring-indigo-500"/>
                            <span className="ml-2 text-slate-700">20%</span>
                        </label>
                        <label className="inline-flex items-center">
                            <input type="radio" name="downPayment" value="15" className="form-radio text-indigo-600 focus:ring-indigo-500"/>
                            <span className="ml-2 text-slate-700">25%</span>
                        </label>
                        <label className="inline-flex items-center">
                            <input type="radio" name="downPayment" value="20" className="form-radio text-indigo-600 focus:ring-indigo-500"/>
                            <span className="ml-2 text-slate-700">30%</span>
                        </label>
                        <label className="inline-flex items-center">
                            <input type="radio" name="downPayment" value="25" className="form-radio text-indigo-600 focus:ring-indigo-500"/>
                ...
                <div>
                    ...
                    <div className="relative">
                        <select id="installmentMonths" className="w-full px-4 py-3 rounded-xl bg-slate-100 text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200 appearance-none">
                ...
                <div className="bg-indigo-50 p-4 rounded-xl text-center">
                    <p className="font-bold text-[19px]">ยอดผ่อนชำระต่อเดือน <span id="installmentAmount" className="text-red-700">0.00</span> บาท</p>
                </div>
